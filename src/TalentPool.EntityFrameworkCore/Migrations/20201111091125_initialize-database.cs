        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EvaluationTime = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilePath = table.Column<string>(maxLength: 2048, nullable: true),
                    CreatorUserId = table.Column<Guid>(nullable: false),
                    CreationTime = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResumeAttachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResumeAttachments_Resumes_ResumeId",
                        column: x => x.ResumeId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    Similarity = table.Column<decimal>(type: "decimal(10,4)", nullable: false),
                    ResumeId = table.Column<Guid>(nullable: false),
                    RelationResumeId = table.Column<Guid>(nullable: false),
                    RelationResumeName = table.Column<string>(maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(maxLength: 1024, nullable: true),
                    ReferenceAnswer = table.Column<string>(maxLength: 3072, nullable: true),
                    Order = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResumeAttachments_ResumeId",
                table: "ResumeAttachments",
                column: "ResumeId");
